...
describe("parseProtoStream", () => {
  ...
  it("should correctly decode protocol buffer events", async () => {
    ...
    headers.append("Content-Type", proto.AGENTWIRE_MEDIA_TYPE);
